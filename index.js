...
class HudView extends React.Component {
  ...
  _renderDefaultSpinnerComponent() {
    return <FontAwesome name="circle-o-notch" size={this._getIconSize()}
  ...
  _renderDefaultErrorComponent() {
    return <FontAwesome name="exclamation-triangle" size={this._getIconSize()}
                        color={this._getIconColor()}/>
  }
  ...
  showCustomIcon(setName, iconName, rotate, hideOnCompletion) {
    ...
    const icon = <_component name={iconName} size={this._getIconSize()}
                             color={this._getIconColor()}/>;
